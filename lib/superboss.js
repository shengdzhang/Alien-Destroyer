(function () {
  ...
  var SuperBoss = AlienDestroyer.SuperBoss = function(options) {
    ...
    this.weaponCooldown;
    this.health = SuperBoss.Radius/4;
  }
  ...
  SuperBoss.prototype.render = function (ctx) {
    ...
    base_image.src = 'images/superboss.png';
    ...
    ctx.fill();
    ctx.drawImage(base_image, this.pos[0] - SuperBoss.RADIUS, this.pos[1] - SuperBoss.RADIUS);
  };
  ...
  SuperBoss.prototype.reduceHealth = function () {
    if(this.radius > SuperBoss.RADIUS/4) {
      this.radius -= 1;
    } else {
      this.health -= 1;
      if(this.health < 1) {
