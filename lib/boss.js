(function () {
  ...
  Boss.prototype.render = function (ctx) {
    ...
    base_image.src = 'images/alienboss.png';
    ...
    ctx.fill();
    ctx.drawImage(base_image, this.pos[0] - Boss.RADIUS/2, this.pos[1] - Boss.RADIUS);
  };
