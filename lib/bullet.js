(function () {
  ...
  Bullet.prototype.render = function (ctx) {
    ...
    base_image.src = 'images/alienbullet.png';
    if (this.mark === "Ship") {
      base_image.src = 'images/shipbullet.png';
    }
    ctx.drawImage(base_image, this.pos[0] - Bullet.RADIUS/2, this.pos[1] - Bullet.RADIUS/2);
  };
