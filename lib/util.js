(function () {
  ...
  AlienDestroyer.Util.randomAlienVec = function(length) {
    ...
    // AlienDestroyer.Util.dir = function (vec) {
    //   var norm = Util.norm(vec);
    //   return AlienDestroyer.Util.scale(vec, 1 / norm);
    // };
    //
    //   AlienDestroyer.Util.norm = function (vec) {
    //     debugger;
    //     return AlienDestroyer.Util.dist([0, 0], vec);
    // };
    //
    // // Scale the length of a vector by the given amount.
    // AlienDestroyer.Util.scale = function (vec, m) {
    //   return [vec[0] * m, vec[1] * m];
    // };
    //
    AlienDestroyer.Util.dist = function (pos1, pos2) {
       return Math.sqrt(
